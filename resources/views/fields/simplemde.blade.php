                ...
                <div class="modal-content-wrapper">
                    <div class="modal-content">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                            <i class="icon-close p-4 v-center text-lg"></i>
                        </button>
                        <div class="full-height">
                            <div class="modal-body">
                                <div class="p-4">
                                    ...
                                    <pre class="p-4">**<strong>bold</strong>**
*<em>italics</em>*
~~<strike>strikethrough</strike>~~</pre>
                                    <h4 class="m-b font-thin">Headers</h4>
                                    <pre class="p-4"># Big header
## Medium header
### Small header
#### Tiny header</pre>
                                    <h4 class="m-b font-thin">Lists</h4>
                                    <pre class="p-4">* Generic list item
* Generic list item
* Generic list item
...
3. Numbered list item</pre>
                                    ...
                                    <pre class="p-4">[Text to display](http://www.example.com)</pre>
                                    <h4 class="m-b font-thin">Quotes</h4>
                                    <pre class="p-4">&gt; This is a quote.
&gt; It can span multiple lines!</pre>
                                    ...
                                    <pre class="p-4">![](http://www.example.com/image.jpg)</pre>
                                    <h4 class="m-b font-thin">Tables</h4>
                                    <pre class="p-4">| Column 1 | Column 2 | Column 3 |
| -------- | -------- | -------- |
| John     | Doe      | Male     |
| Mary     | Smith    | Female   |
...
| Mary | Smith | Female |
                                    ...
                                    <pre class="p-4">`var example = "hello!";`
